...
export class RegisteredUserApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public findByIdAccountEvents(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/account/events/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
   ...
   * This method returns no data.
   */
  public destroyByIdAccountEvents(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/account/events/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public updateByIdAccountEvents(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/account/events/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public getAccountEvents(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/account/events";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createAccountEvents(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/account/events";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public deleteAccountEvents(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/account/events";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countAccountEvents(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/account/events/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyAccountEvents(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/RegisteredUsers/:id/account/events";
    let _routeParams: any = {
